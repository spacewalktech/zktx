...
public interface MrTaskMapper {
	...
	List<MrTaskWithBLOBs> findByPagination(@Param("latest_running_status") Integer latest_running_status, @Param("offset") Integer offset,
			@Param("limit") Integer limit, @Param("search_name") String search_name, @Param("search_type") String search_type,
			@Param("search_triggle_tables") String search_triggle_tables, @Param("search_active") String search_active,
			@Param("search_create_time_begin") String search_create_time_begin, @Param("search_create_time_end") String search_create_time_end);
	...
	int findCountByPagination(@Param("latest_running_status") Integer latest_running_status, @Param("search_name") String search_name,
			@Param("search_type") String search_type, @Param("search_triggle_tables") String search_triggle_tables,
			@Param("search_active") String search_active, @Param("search_create_time_begin") String search_create_time_begin,
	...
	List<MrTaskWithBLOBs> findAllMrTaskWithBLOBs();
