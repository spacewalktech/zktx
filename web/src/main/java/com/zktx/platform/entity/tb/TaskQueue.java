...
public class TaskQueue {
	...
	private MrTaskWithBLOBs taskWithBLOBs;
	...
	public MrTaskWithBLOBs getTaskWithBLOBs() {
		return taskWithBLOBs;
	}

	public void setTaskWithBLOBs(MrTaskWithBLOBs taskWithBLOBs) {
		this.taskWithBLOBs = taskWithBLOBs;
	}
