			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<datalist id="list_dbname"> <c:forEach var="i" items="${dbList}">
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						...
						<datalist id="list_src_db"> <c:forEach var="i" items="${src_dbList}">
							<option value="${i}">${i }</option>
						</c:forEach> </datalist>
						<i></i>
					</div>
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="checkbox-inline">
							<label>
								<input type="radio" name="export_to_sql_warehouse" value="1" checked>
								是
							</label>
						</div>
						<div class="checkbox-inline">
							<label>
								<input type="radio" name="export_to_sql_warehouse" value="0">
								否
							</label>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="checkbox-inline">
							<label>
								<input type="radio" name="export_to_es_index_warehouse" value="1" checked>
								是
							</label>
						</div>
						<div class="checkbox-inline">
							<label>
								<input type="radio" name="export_to_es_index_warehouse" value="0">
								否
							</label>
						</div>
					</div>
